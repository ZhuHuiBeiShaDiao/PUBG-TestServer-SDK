...
namespace Classes {
	...
	public:
		...
		unsigned char                                      UnknownData00[0x28];                                      // 0x0700(0x0028) MISSED OFFSET
		unsigned char                                      UnknownData01 : 1;                                        // 0x0728(0x0001)
		unsigned char                                      bIsSpectated : 1;                                         // 0x0728(0x0001) (CPF_Net, CPF_Transient)
		unsigned char                                      UnknownData02[0x3];                                       // 0x0729(0x0003) MISSED OFFSET
		struct FVector                                     CameraPeekLeftMove;                                       // 0x072C(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     CameraPeekRightMove;                                      // 0x0738(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData03[0x10];                                      // 0x0744(0x0010) MISSED OFFSET
		ECameraViewBehaviour                               CameraViewBehaviour;                                      // 0x0754(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData04[0x23];                                      // 0x0755(0x0023) MISSED OFFSET
		struct FVector_NetQuantizeNormal                   SpectatorAccumViewRotation;                               // 0x0778(0x000C) (CPF_Net, CPF_Transient)
		EObserverAuthorityType                             ObserverAuthorityType;                                    // 0x0784(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData05[0x33];                                      // 0x0785(0x0033) MISSED OFFSET
		class UActorComponent*                             InteractionTargetComponent;                               // 0x07B8(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_IsPlainOldData)
		class ATslCharacter*                               SpectatorViewCharacter;                                   // 0x07C0(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData06[0x10];                                      // 0x07C8(0x0010) MISSED OFFSET
		class ATslAchievement*                             Achievement;                                              // 0x07D8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UMeshComponent*                              SpectatorScopeMesh;                                       // 0x07E0(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_IsPlainOldData)
		unsigned char                                      UnknownData07[0x58];                                      // 0x07E8(0x0058) MISSED OFFSET
		TArray<struct FNearClippingLevelOverZ>             NearClippingLevelsOverZ;                                  // 0x0840(0x0010) (CPF_ZeroConstructor, CPF_Config)
		float                                              MaxValidPing;                                             // 0x0850(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              DefaultFOV;                                               // 0x0854(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              InteractGamepadHoldTime;                                  // 0x0858(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData08[0x4];                                       // 0x085C(0x0004) MISSED OFFSET
		class UVivoxComponent*                             VivoxComponent;                                           // 0x0860(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
		TArray<class ATeam*>                               Teams;                                                    // 0x0868(0x0010) (CPF_Net, CPF_ZeroConstructor)
		TArray<TWeakObjectPtr<class ATslCharacter>>        ReplicateTeamMembers;                                     // 0x0878(0x0010) (CPF_ZeroConstructor)
		unsigned char                                      UnknownData09[0x50];                                      // 0x0888(0x0050) MISSED OFFSET
		TArray<TWeakObjectPtr<class ATslCharacter>>        ReplicateCharacter;                                       // 0x08D8(0x0010) (CPF_ZeroConstructor)
		TArray<TWeakObjectPtr<class ACarePackageItem>>     ReplicateCarePackageItemList;                             // 0x08E8(0x0010) (CPF_ZeroConstructor)
		unsigned char                                      UnknownData10[0x20];                                      // 0x08F8(0x0020) MISSED OFFSET
		float                                              DeathResultDelaySeconds;                                  // 0x0918(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData11[0x90];                                      // 0x091C(0x0090) MISSED OFFSET
		struct FPingPongSummary                            PingPongSummary;                                          // 0x09AC(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Net, CPF_Transient)
		unsigned char                                      UnknownData12[0x60];                                      // 0x09B8(0x0060) MISSED OFFSET
		...
		void ServerSystemInfo(const struct FString& WindowsLanguage, const struct FString& GameLanguage, const struct FString& OsVersion, const struct FString& CpuName, const struct FString& GpuName, uint32_t RamInGB);
		void ServerSuicide();
	...
	public:
		...
		struct FScriptDelegate                             OnCreateAndShowContextMenuWidget;                         // 0x03C0(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference)
		struct FScriptDelegate                             OnDestroyContextMenuWidget;                               // 0x03D0(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference)
	...
	public:
		...
		struct FScriptDelegate                             OnUpdateItemList;                                         // 0x03F0(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference)
		struct FScriptDelegate                             OnClearItemList;                                          // 0x0400(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference)
	...
	public:
		unsigned char                                      UnknownData00[0x180];                                     // 0x01E0(0x0180) MISSED OFFSET
	...
	// 0x0228 (0x03E8 - 0x01C0)
	class UAttachableItem : public UItem {
	public:
		struct FWeaponAttachmentData                       AttachmentData;                                           // 0x01C0(0x01E8) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance)
		TAssetPtr<class UStaticMesh>                       AttachmentMeshAsset;                                      // 0x03A8(0x0020) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance)
		TArray<struct FWeaponAttachmentWeaponTagData>      AttachmentWeaponTagData;                                  // 0x03C8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
		bool                                               EquipOnPickUp;                                            // 0x03D8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData00[0x7];                                       // 0x03D9(0x0007) MISSED OFFSET
		class UAkAudioEvent*                               AttachedSoundAk;                                          // 0x03E0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	public:
		struct FCastConfig                                 CastConfig;                                               // 0x01C0(0x0030) (CPF_Edit, CPF_DisableEditOnInstance)
		bool                                               bCanUseInWater;                                           // 0x01F0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		ECastableItemType                                  CastableItemType;                                         // 0x01F1(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	class UInstantHealItem : public UCastableItem {
	public:
		float                                              HealLimit;                                                // 0x01F8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	public:
		struct FSkinData                                   SkinData;                                                 // 0x01F8(0x0020) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance)
		bool                                               bAutoAction;                                              // 0x0218(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	public:
		...
		float                                              BombingSoundDelay;                                        // 0x04C0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              OuterRadius;                                              // 0x04C4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   LimitExceptExplosionRadius;                               // 0x04C8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              ExceptExplosionRadius;                                    // 0x04D0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              BombProjectileDelayTime;                                  // 0x04D4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              RedZoneDuration;                                          // 0x04D8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   BombingInterval;                                          // 0x04DC(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              RedZoneLifeTime;                                          // 0x04E4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              ReyStartHeight;                                           // 0x04E8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              RedZoneRadiusOffsetRate;                                  // 0x04EC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		...
		unsigned char                                      UnknownData02[0x14];                                      // 0x052C(0x0014) MISSED OFFSET
	...
	public:
		...
		struct FWeaponPPSettings                           WeaponGunPostprocessSettings;                             // 0x0A80(0x0050) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FName                                       ScopingAttachPoint;                                       // 0x0AD0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FName                                       ScopingFocusPoint;                                        // 0x0AD8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	public:
		...
		unsigned char                                      UnknownData01[0x80];                                      // 0x03C8(0x0080) MISSED OFFSET
		TArray<class ATslWeapon*>                          EquippedWeapons;                                          // 0x0448(0x0010) (CPF_Net, CPF_ZeroConstructor, CPF_Transient)
		int                                                CurrentWeaponIndex;                                       // 0x0458(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData02[0x14];                                      // 0x045C(0x0014) MISSED OFFSET
	...
	public:
		...
		TMap<ESlotOffsetType, struct FItemOffsetData>      ItemOffsetConfig;                                         // 0x08B8(0x0050) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
		unsigned char                                      UnknownData03[0x48];                                      // 0x0908(0x0048) MISSED OFFSET
		class AController*                                 LastPossessedController;                                  // 0x0950(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		TArray<class UAkAudioBank*>                        Banks;                                                    // 0x0958(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		class UBuffComponet*                               BuffComponent;                                            // 0x0968(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
		unsigned char                                      UnknownData04[0x40];                                      // 0x0970(0x0040) MISSED OFFSET
		ECastAnim                                          Remote_CastAnim;                                          // 0x09B0(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData05[0x7];                                       // 0x09B1(0x0007) MISSED OFFSET
		class ATslCharacter*                               RevivingCharacter;                                        // 0x09B8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		class ATslPlayerState*                             GroggyPlayerInstigator;                                   // 0x09C0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		TMap<class UCameraComponent*, float>               SavedCameraFOV;                                           // 0x09C8(0x0050) (CPF_ZeroConstructor)
		class UCameraComponent*                            SavedCamera;                                              // 0x0A18(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
		unsigned char                                      UnknownData06[0x20];                                      // 0x0A20(0x0020) MISSED OFFSET
		int                                                CurrentVariableZoomLevel;                                 // 0x0A40(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              BuffFinalSpreadFactor;                                    // 0x0A44(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		class AInventoryFacade*                            InventoryFacade;                                          // 0x0A48(0x0008) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		class AWeaponProcessor*                            WeaponProcessor;                                          // 0x0A50(0x0008) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      CharacterState;                                           // 0x0A58(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData07[0x1F];                                      // 0x0A59(0x001F) MISSED OFFSET
		class UClass*                                      DropPackageType;                                          // 0x0A78(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               SoundClearAk;                                             // 0x0A80(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               RemoteVolumeControlOn;                                    // 0x0A88(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               RemoteVolumeControlOff;                                   // 0x0A90(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 CameraFovRatioCurve;                                      // 0x0A98(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              HeavyFallVerticalVelocityThreshold;                       // 0x0AA0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              ExtremeFallVerticalVelocityThreshold;                     // 0x0AA4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              ProneFallVerticalVelocityThreshold;                       // 0x0AA8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              HeavyFallMovementStopTime;                                // 0x0AAC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              ExtremeFallMovementStopTime;                              // 0x0AB0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData08[0x4];                                       // 0x0AB4(0x0004) MISSED OFFSET
		float                                              Punch_Damage;                                             // 0x0AB8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              PunchHeavy_Damage;                                        // 0x0ABC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UClass*                                      UnarmedDamageType;                                        // 0x0AC0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UClass*                                      ZombieDamageType;                                         // 0x0AC8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              Punch_Distance;                                           // 0x0AD0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              PunchHeavy_Distance;                                      // 0x0AD4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              Punch_Radius;                                             // 0x0AD8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              PunchHeavy_Radius;                                        // 0x0ADC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     Punch_InitialLocation;                                    // 0x0AE0(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData09[0x4];                                       // 0x0AEC(0x0004) MISSED OFFSET
		struct FVector                                     LeanLeftTraceOffset;                                      // 0x0AF0(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     LeanRightTraceOffset;                                     // 0x0AFC(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData10[0x8];                                       // 0x0B08(0x0008) MISSED OFFSET
		float                                              LeanOffset_Stand;                                         // 0x0B10(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              LeanOffset_Crouch;                                        // 0x0B14(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              LeanOffset_Prone;                                         // 0x0B18(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData11[0x10];                                      // 0x0B1C(0x0010) MISSED OFFSET
		float                                              Sprint_MaxSpeed;                                          // 0x0B2C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              Sprint_MinSpeed;                                          // 0x0B30(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SprintingFOV;                                             // 0x0B34(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              MinimumBreathToHold;                                      // 0x0B38(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData12[0x4];                                       // 0x0B3C(0x0004) MISSED OFFSET
		struct FName                                       SwimPoint;                                                // 0x0B40(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SwimableWaterDepth;                                       // 0x0B48(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              CrouchWaterDepth;                                         // 0x0B4C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              ProneWaterDepth;                                          // 0x0B50(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WaterFloorDetectionLength;                                // 0x0B54(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SwimMaxControllerPitch;                                   // 0x0B58(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              UnderwaterSwimGapFromSurface;                             // 0x0B5C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UClass*                                      SwimTrailEffectClass;                                     // 0x0B60(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class ATslParticle*                                SwimTrailEffect;                                          // 0x0B68(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		struct FName                                       ParticleSocket_SwimIdleRipple;                            // 0x0B70(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UClass*                                      SwimIdleRippleEffectClass;                                // 0x0B78(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                maxNumSwimIdleRippleEffect;                               // 0x0B80(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SwimIdleRippleOffsetFromSurface;                          // 0x0B84(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData13[0x18];                                      // 0x0B88(0x0018) MISSED OFFSET
		class UCharacterBreathComponent*                   BreathComponent;                                          // 0x0BA0(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		struct FName                                       BreathPoint;                                              // 0x0BA8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UClass*                                      UnderwaterChokeEffectClass;                               // 0x0BB0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class ATslParticle*                                UnderwaterChokeEffect;                                    // 0x0BB8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              IndoorCheckDistance;                                      // 0x0BC0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData14[0x4];                                       // 0x0BC4(0x0004) MISSED OFFSET
		float                                              IndoorCheckHalfConeAngle;                                 // 0x0BC8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              IndoorCheckSuccessRate;                                   // 0x0BCC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                IndoorCheckSamplingQueueSize;                             // 0x0BD0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                IndoorCheckAccuracyMultiplier;                            // 0x0BD4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData15[0x10];                                      // 0x0BD8(0x0010) MISSED OFFSET
		...
		unsigned char                                      UnknownData16[0x8];                                       // 0x0BF0(0x0008) MISSED OFFSET
		...
		unsigned char                                      UnknownData17[0x4];                                       // 0x0C0C(0x0004) MISSED OFFSET
		class UClass*                                      ParachuteType;                                            // 0x0C10(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		bool                                               bParachuteLandingAssist;                                  // 0x0C18(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData18[0x7];                                       // 0x0C19(0x0007) MISSED OFFSET
		...
		bool                                               bAcceptHitsWhileNotAlive;                                 // 0x0C38(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData19[0x3];                                       // 0x0C39(0x0003) MISSED OFFSET
		...
		unsigned char                                      UnknownData21[0x28];                                      // 0x0C60(0x0028) MISSED OFFSET
		...
		unsigned char                                      UnknownData22[0x20];                                      // 0x0D00(0x0020) MISSED OFFSET
		...
		unsigned char                                      UnknownData23[0x20];                                      // 0x0D38(0x0020) MISSED OFFSET
		...
		unsigned char                                      UnknownData24[0xC];                                       // 0x0D84(0x000C) MISSED OFFSET
		struct FVector                                     CrouchedCameraMove;                                       // 0x0D90(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     PronedCameraMove;                                         // 0x0D9C(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     GroggyCameraMove;                                         // 0x0DA8(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		...
		unsigned char                                      UnknownData25[0x48];                                      // 0x0DC0(0x0048) MISSED OFFSET
		struct FTakeHitInfo                                LastTakeHitInfo;                                          // 0x0E08(0x0040) (CPF_Net, CPF_Transient)
		unsigned char                                      UnknownData26[0x4];                                       // 0x0E48(0x0004) MISSED OFFSET
		float                                              TargetingSpeedModifier;                                   // 0x0E4C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		TEnumAsByte<ETargetingType>                        TargetingType;                                            // 0x0E50(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData27[0x3];                                       // 0x0E51(0x0003) MISSED OFFSET
		...
		unsigned char                                      UnknownData28 : 1;                                        // 0x0E7D(0x0001)
		...
		unsigned char                                      UnknownData29[0x2];                                       // 0x0E7E(0x0002) MISSED OFFSET
		bool                                               bUseRightShoulderAiming;                                  // 0x0E80(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData30[0x3];                                       // 0x0E81(0x0003) MISSED OFFSET
		struct FRotator                                    GunDirectionSway;                                         // 0x0E84(0x000C) (CPF_Net, CPF_Transient, CPF_IsPlainOldData)
		struct FVector_NetQuantizeNormal                   AimOffsets;                                               // 0x0E90(0x000C) (CPF_Net, CPF_Transient)
		struct FVector_NetQuantizeNormal                   LastAimOffsets;                                           // 0x0E9C(0x000C)
		float                                              AimoffsetsLastRepTime;                                    // 0x0EA8(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData31[0x38];                                      // 0x0EAC(0x0038) MISSED OFFSET
		struct FRotator                                    CurrentAutoRotator;                                       // 0x0EE4(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AutoPitchValueMax;                                        // 0x0EF0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AutoPitchBlendSpeed;                                      // 0x0EF4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData32[0x8];                                       // 0x0EF8(0x0008) MISSED OFFSET
		class UCurveFloat*                                 Curve_JumpCamera;                                         // 0x0F00(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveVector*                                Curve_FPPCameraOffsetByFOV;                               // 0x0F08(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_DBNOFadeOut;                                        // 0x0F10(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              DBNOFadeOutLerpSpeed;                                     // 0x0F18(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData33[0x4];                                       // 0x0F1C(0x0004) MISSED OFFSET
		class UCurveFloat*                                 Curve_StandWalk;                                          // 0x0F20(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_StandRun;                                           // 0x0F28(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_StandSprint;                                        // 0x0F30(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_CrouchWalk;                                         // 0x0F38(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_CrouchRun;                                          // 0x0F40(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_CrouchSprint;                                       // 0x0F48(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_ProneWalk;                                          // 0x0F50(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_ProneRun;                                           // 0x0F58(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_ProneSprint;                                        // 0x0F60(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_Swim;                                               // 0x0F68(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_UnderwaterSwim;                                     // 0x0F70(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_StandScope;                                         // 0x0F78(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_CrouchScope;                                        // 0x0F80(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_ProneScope;                                         // 0x0F88(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_StandAim;                                           // 0x0F90(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_CrouchAim;                                          // 0x0F98(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_ProneAim;                                           // 0x0FA0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_DBNO;                                               // 0x0FA8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_GroundAngle;                                        // 0x0FB0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveVector*                                Curve_WeaponSway;                                         // 0x0FB8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_TurningLerp;                                        // 0x0FC0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_TurningLerpLocomotion;                              // 0x0FC8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              DirectionalSpeedModifier;                                 // 0x0FD0(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              PointDamageForceMultiplier;                               // 0x0FD4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              PointDamageForce_MapMin;                                  // 0x0FD8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              PointDamageForce_MapMax;                                  // 0x0FDC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              RadialDamageForceMultiplier;                              // 0x0FE0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		TEnumAsByte<ERadialImpulseFalloff>                 RadialDamageFalloffType;                                  // 0x0FE4(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData34[0x3];                                       // 0x0FE5(0x0003) MISSED OFFSET
		class UAnimMontage*                                RollLeftAnim;                                             // 0x0FE8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimMontage*                                RollRightAnim;                                            // 0x0FF0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FCharacterAnim                              CharacterAnim;                                            // 0x0FF8(0x0010) (CPF_Edit, CPF_DisableEditOnInstance)
		class AController*                                 NetOwnerController;                                       // 0x1008(0x0008) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              LeanAlphaSpeed;                                           // 0x1010(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              TurnSpeedHip;                                             // 0x1014(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              TurnSpeedAimed;                                           // 0x1018(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              TurnSpeedOverLimit;                                       // 0x101C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              MinTurnAngleHip;                                          // 0x1020(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              MinTurnAngleAim;                                          // 0x1024(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              TurnLinearEndThreshold;                                   // 0x1028(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bNonLinearTurn;                                           // 0x102C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData35[0x3];                                       // 0x102D(0x0003) MISSED OFFSET
		float                                              TurnNonLinearEndThreshold;                                // 0x1030(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              TurnNonLinearInterpSpeed;                                 // 0x1034(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              CapsuleTurnInterpSpeedLocomotion;                         // 0x1038(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              CapsuleTurnInterpSpeedLocomotionSprint;                   // 0x103C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              CapsuleTurnInterpSpeedLocomotionProne;                    // 0x1040(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              CapsuleTurnInterpSpeedStationary;                         // 0x1044(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData36[0x18];                                      // 0x1048(0x0018) MISSED OFFSET
		struct FName                                       FPPCameraBoneName;                                        // 0x1060(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FName                                       TPPCameraBoneName;                                        // 0x1068(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData37[0xC];                                       // 0x1070(0x000C) MISSED OFFSET
		float                                              AimStateDefaultTime;                                      // 0x107C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AimStateReturnTime;                                       // 0x1080(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AimStateDrawTime;                                         // 0x1084(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData38[0x8];                                       // 0x1088(0x0008) MISSED OFFSET
		bool                                               bAimStateActive;                                          // 0x1090(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData39[0x3];                                       // 0x1091(0x0003) MISSED OFFSET
		float                                              CanGroggyDamageTime;                                      // 0x1094(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		...
		unsigned char                                      UnknownData40[0xC];                                       // 0x10E4(0x000C) MISSED OFFSET
		struct FRotator                                    BlendTargetViewRotation;                                  // 0x10F0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   DesiredDirection;                                         // 0x10FC(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		unsigned char                                      UnknownData41[0x4];                                       // 0x1104(0x0004) MISSED OFFSET
		...
		bool                                               bInvulnerablilityEffectVisible;                           // 0x1110(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData42[0x7];                                       // 0x1111(0x0007) MISSED OFFSET
		...
		bool                                               bIsHoldingBreath;                                         // 0x1138(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData43[0x3];                                       // 0x1139(0x0003) MISSED OFFSET
		...
		unsigned char                                      UnknownData44[0x4];                                       // 0x1154(0x0004) MISSED OFFSET
		...
		unsigned char                                      UnknownData45[0x4];                                       // 0x1164(0x0004) MISSED OFFSET
		...
		unsigned char                                      UnknownData46[0x4];                                       // 0x1200(0x0004) MISSED OFFSET
		...
		unsigned char                                      UnknownData47[0x4];                                       // 0x1214(0x0004) MISSED OFFSET
		...
		EEquipableItemSoundType                            ShoesSoundType;                                           // 0x1230(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData48[0x7];                                       // 0x1231(0x0007) MISSED OFFSET
		...
		class UVehicleRiderComponent*                      VehicleRiderComponent;                                    // 0x1248(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ExportObject, CPF_BlueprintReadOnly, CPF_Net, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		class UClass*                                      OutSidePlayerAreaEffectClass;                             // 0x1250(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class ATslPostProcessEffect*                       OutSidePlayerAreaEffect;                                  // 0x1258(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		class UClass*                                      DBNOEffectClass;                                          // 0x1260(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class ATslPostProcessEffect*                       DBNOEffect;                                               // 0x1268(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData49[0x1E0];                                     // 0x1270(0x01E0) MISSED OFFSET
		class USkeletalMeshComponent*                      ShadowMesh;                                               // 0x1450(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_IsPlainOldData)
		float                                              TargetingFOV;                                             // 0x1458(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              AimingDelay;                                              // 0x145C(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData50[0x4];                                       // 0x1460(0x0004) MISSED OFFSET
		float                                              ScopingDelay;                                             // 0x1464(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              AttackStateOffDelayTime;                                  // 0x1468(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              HitStateOffDelayTime;                                     // 0x146C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              HitMePlayerStateOffDelayTime;                             // 0x1470(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData51[0x34];                                      // 0x1474(0x0034) MISSED OFFSET
		class UTslPlayerDamageConfig*                      DamageConfig;                                             // 0x14A8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData52[0x4];                                       // 0x14B0(0x0004) MISSED OFFSET
		float                                              FallDamageFactor;                                         // 0x14B4(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              FallDamageVelocityMin;                                    // 0x14B8(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bIsActiveRagdollActive;                                   // 0x14BC(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData53[0x3];                                       // 0x14BD(0x0003) MISSED OFFSET
		float                                              CorpseLifeSpan;                                           // 0x14C0(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData54[0x54];                                      // 0x14C4(0x0054) MISSED OFFSET
		struct FVector                                     JumpStartLocation_CP;                                     // 0x1518(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     LandPredictedLocation_CP;                                 // 0x1524(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              FallHeight_CP;                                            // 0x1530(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bIsVaulting_CP;                                           // 0x1534(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData55[0x3];                                       // 0x1535(0x0003) MISSED OFFSET
		float                                              VaultTimer_CP;                                            // 0x1538(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     VaultEndVelocity_CP;                                      // 0x153C(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     VaultLastLocation_CP;                                     // 0x1548(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bIsClimbing_CP;                                           // 0x1554(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bEndVaultToFall_CP;                                       // 0x1555(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData56[0x2];                                       // 0x1556(0x0002) MISSED OFFSET
		struct FVector                                     VaultEndVelocityVectorMutliplier;                         // 0x1558(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              VaultEndVelocityVectorClamp;                              // 0x1564(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class ATslVaultingHelper*                          VaultingHelperRef;                                        // 0x1568(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_IsPlainOldData)
		bool                                               bIsVaultingSystemEnabled;                                 // 0x1570(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData57[0x3];                                       // 0x1571(0x0003) MISSED OFFSET
		float                                              VaultingDirection_CP;                                     // 0x1574(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnTemplate, CPF_EditConst, CPF_IsPlainOldData)
		class UVaultingData*                               CurrentVaultData_CP;                                      // 0x1578(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bServerFinishedVault;                                     // 0x1580(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData58[0x3];                                       // 0x1581(0x0003) MISSED OFFSET
		float                                              JumpDelay;                                                // 0x1584(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              JumpLastTimer;                                            // 0x1588(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bWantsToVault;                                            // 0x158C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bWantsToCancelVault;                                      // 0x158D(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData59[0x2];                                       // 0x158E(0x0002) MISSED OFFSET
		float                                              VaultProbeLoopTime;                                       // 0x1590(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData60[0x4];                                       // 0x1594(0x0004) MISSED OFFSET
		struct FAnimUpdateRateSettings                     AnimationUpdateRateSettings;                              // 0x1598(0x0078) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance)
		float                                              TO_CulledMovementTickrate;                                // 0x1610(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              TO_CulledActorTickInterval;                               // 0x1614(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              TO_MinimumDistance;                                       // 0x1618(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bRunTickOptimization;                                     // 0x161C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bRunTickOptimization_Anim;                                // 0x161D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bRunTickOptimization_Movement;                            // 0x161E(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData61[0x1];                                       // 0x161F(0x0001) MISSED OFFSET
		float                                              TO_RenderedTolerance;                                     // 0x1620(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bTickOptimization_Move_Active;                            // 0x1624(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		bool                                               bTickOptimization_Anim_Active;                            // 0x1625(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		bool                                               bTickOptimization_Actor_Active;                           // 0x1626(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData62[0x5];                                       // 0x1627(0x0005) MISSED OFFSET
		float                                              GamepadReloadHoldTime;                                    // 0x162C(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              GamepadUnarmHoldTime;                                     // 0x1630(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              GamepadNextGunWeaponTabMaxTime;                           // 0x1634(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData63[0x50];                                      // 0x1638(0x0050) MISSED OFFSET
		class UBluezoneInOutComponent*                     BluezoneInOut;                                            // 0x1688(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_DisableEditOnInstance, CPF_InstancedReference, CPF_IsPlainOldData)
		class UBluezoneInOutSoundEffectComponent*          BluezoneInOutSoundEffect;                                 // 0x1690(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_DisableEditOnInstance, CPF_InstancedReference, CPF_IsPlainOldData)
		unsigned char                                      UnknownData64[0x8];                                       // 0x1698(0x0008) MISSED OFFSET
	...
	public:
		...
		struct FScriptDelegate                             OnRelease;                                                // 0x0420(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference)
		struct FScriptDelegate                             OnLand;                                                   // 0x0430(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference)
	...
	public:
		struct FScriptDelegate                             OnChangeItemExplorerProxy;                                // 0x0418(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference)
	...
	// 0x0308 (0x0728 - 0x0420)
	class ATslWheeledVehicle : public AWheeledVehicle {
	public:
		unsigned char                                      UnknownData00[0x20];                                      // 0x0420(0x0020) MISSED OFFSET
		class USphereComponent*                            ActivationTrigger;                                        // 0x0440(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_InstancedReference, CPF_IsPlainOldData)
		float                                              Health;                                                   // 0x0448(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_EditConst, CPF_IsPlainOldData)
		float                                              HealthMax;                                                // 0x044C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              Fuel;                                                     // 0x0450(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_EditConst, CPF_IsPlainOldData)
		float                                              FuelMax;                                                  // 0x0454(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bStabilizeActive;                                         // 0x0458(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x3];                                       // 0x0459(0x0003) MISSED OFFSET
		float                                              AirControlPitchInput;                                     // 0x045C(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              SpeedKPH;                                                 // 0x0460(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              ThrottleInput;                                            // 0x0464(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              RPM;                                                      // 0x0468(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              Brake;                                                    // 0x046C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              LatMax;                                                   // 0x0470(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              LongSum;                                                  // 0x0474(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              WaterDepthMax;                                            // 0x0478(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              SurfaceMax;                                               // 0x047C(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              SuspensionMax;                                            // 0x0480(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		int                                                FlatTireCount;                                            // 0x0484(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      bDirtySpeedKPH : 1;                                       // 0x0488(0x0001)
		unsigned char                                      bDirtyThrottleInput : 1;                                  // 0x0488(0x0001)
		unsigned char                                      bDirtyRPM : 1;                                            // 0x0488(0x0001)
		unsigned char                                      bDirtyWaterDepthMax : 1;                                  // 0x0488(0x0001)
		unsigned char                                      bDirtyBrake : 1;                                          // 0x0488(0x0001)
		unsigned char                                      bDetectedStartup : 1;                                     // 0x0488(0x0001)
		unsigned char                                      bDetectedBraking : 1;                                     // 0x0488(0x0001)
		unsigned char                                      UnknownData02[0x7];                                       // 0x0489(0x0007) MISSED OFFSET
		TArray<float>                                      WheelsLatSlip;                                            // 0x0490(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		TArray<float>                                      WheelsLongSlip;                                           // 0x04A0(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		TArray<float>                                      WheelsSuspensionOffset;                                   // 0x04B0(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		TArray<class UPhysicalMaterial*>                   WheelsContactSurface;                                     // 0x04C0(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		TArray<class UPhysicalMaterial*>                   TestWheelsContactSurface_prev;                            // 0x04D0(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		TArray<float>                                      WheelsSuspensionMaxDrop;                                  // 0x04E0(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
		TArray<float>                                      WheelsSuspensionMaxRaise;                                 // 0x04F0(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
		class UAkAudioEvent*                               NullSound;                                                // 0x0500(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTslImpactSoundInfo                         ImpactSound;                                              // 0x0508(0x0060) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTslImpactSoundInfo                         LandingSound;                                             // 0x0568(0x0060) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               StartupSound;                                             // 0x05C8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               BreakSound;                                               // 0x05D0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               StopSound;                                                // 0x05D8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               CharacterHitSound;                                        // 0x05E0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              MaxClampThrottleInClutch;                                 // 0x05E8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bApplyCustomAnimUpdaterateSettings;                       // 0x05EC(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData03[0x3];                                       // 0x05ED(0x0003) MISSED OFFSET
		struct FAnimUpdateRateSettings                     AnimUpdateRateSettings;                                   // 0x05F0(0x0078) (CPF_Edit, CPF_DisableEditOnInstance)
		unsigned char                                      bWantsToBoosting : 1;                                     // 0x0668(0x0001) (CPF_Net, CPF_Transient)
		unsigned char                                      UnknownData04[0x3];                                       // 0x0669(0x0003) MISSED OFFSET
		float                                              TorqueMultiplierForBoosting;                              // 0x066C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData05[0x8];                                       // 0x0670(0x0008) MISSED OFFSET
		class UTslVehicleHitComponent*                     VehicleHitComponent;                                      // 0x0678(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		class UTslVehicleCommonComponent*                  VehicleCommonComponent;                                   // 0x0680(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		class UTslVehicleSeatComponent*                    VehicleSeatComponent;                                     // 0x0688(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		class UTslVehicleEffectComponent*                  VehicleEffectComponent;                                   // 0x0690(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		class UTslVehicleSyncComponent*                    VehicleSyncComponent;                                     // 0x0698(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		class UTslVehicleTempComponent*                    VehicleTempComponent;                                     // 0x06A0(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		class UTslPawnInputBindingComponent*               TslPawnInputBindingComponent;                             // 0x06A8(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
		class UTslHornComponent*                           TslHornComponent;                                         // 0x06B0(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		class UAkComponent*                                AudioComEngine;                                           // 0x06B8(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_IsPlainOldData)
		class UBuoyancyForceComponent*                     BuoyancyForceComponent;                                   // 0x06C0(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		struct FName                                       SinkPoint;                                                // 0x06C8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UClass*                                      SinkBuffType;                                             // 0x06D0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData06[0x8];                                       // 0x06D8(0x0008) MISSED OFFSET
		class UBuffComponet*                               BuffComponent;                                            // 0x06E0(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
		TArray<class UClass*>                              ComponentsToDestroyOnDedicatedServer;                     // 0x06E8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
		bool                                               bProcessAutoEject;                                        // 0x06F8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData07[0x3];                                       // 0x06F9(0x0003) MISSED OFFSET
		float                                              AutoEjectGroundDistance;                                  // 0x06FC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AutoEjectRoll;                                            // 0x0700(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AutoEjectPitch;                                           // 0x0704(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AutoEject_RiseRate;                                       // 0x0708(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AutoEject_FallRate;                                       // 0x070C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData08[0x4];                                       // 0x0710(0x0004) MISSED OFFSET
		bool                                               bRunStabilizeOnEntry;                                     // 0x0714(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData09[0x3];                                       // 0x0715(0x0003) MISSED OFFSET
		float                                              StabilizeInitialTimer;                                    // 0x0718(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              StablizeCurrentTimer;                                     // 0x071C(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              SteeringYawBias;                                          // 0x0720(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	public:
		...
		float                                              MaxProneSpeed;                                            // 0x08A0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              MaxGroggySpeed;                                           // 0x08A4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              JumpedHalfHeight;                                         // 0x08A8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              JumpVelocityLossScale;                                    // 0x08AC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              SpeedToJumpModifier;                                      // 0x08B0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              MinJumpZVelocity;                                         // 0x08B4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              MaxJumpZVelocity;                                         // 0x08B8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LandingJumpDecreaseModifier;                              // 0x08BC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              RecoveryWalkSpeedRatePerSec;                              // 0x08C0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              MinWalkSpeedModifier;                                     // 0x08C4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              WalkSpeedModifierUnit;                                    // 0x08C8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              MinStandingJumpXYSpeed;                                   // 0x08CC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              SpeedInWaterModifier;                                     // 0x08D0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bUseCPVault;                                              // 0x08D4(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x3];                                       // 0x08D5(0x0003) MISSED OFFSET
		TMap<EVaultAnimType, class UVaultingData*>         VaultingDataMap;                                          // 0x08D8(0x0050) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
		int                                                HeightFor200;                                             // 0x0928(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                HeightFor160;                                             // 0x092C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                HeightFor120;                                             // 0x0930(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                HeightFor90;                                              // 0x0934(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                HeightFor60;                                              // 0x0938(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SizeForNarrow;                                            // 0x093C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                SizeForSlide;                                             // 0x0940(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              VelocityForMobile;                                        // 0x0944(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              GlobalVaultScale;                                         // 0x0948(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              VaultCancelDTScalar;                                      // 0x094C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              MinVelocityForStaticVaultCheck;                           // 0x0950(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   MaxVaultDistanceByVelocityInMap;                          // 0x0954(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   MaxVaultDistanceByVelocityOutMap;                         // 0x095C(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVaultingTask                               CurrentVaultingTask;                                      // 0x0964(0x0040) (CPF_BlueprintVisible, CPF_BlueprintReadOnly)
		unsigned char                                      UnknownData02[0x4];                                       // 0x09A4(0x0004) MISSED OFFSET
		class UVaultingData*                               CurrentVaultingData;                                      // 0x09A8(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              V_Timer_CP;                                               // 0x09B0(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AnimMultiplierPreApex;                                    // 0x09B4(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AnimMultiplierPostApex;                                   // 0x09B8(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsVaulting_CP;                                           // 0x09BC(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData03[0x3];                                       // 0x09BD(0x0003) MISSED OFFSET
		struct FVector                                     CharacterRelLocation;                                     // 0x09C0(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FVector                                     LastVaultLocation;                                        // 0x09CC(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FVector                                     AveragedVelocity;                                         // 0x09D8(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		float                                              LastVaultTime;                                            // 0x09E4(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultCancelAnimSpeed;                                     // 0x09E8(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bWantsToCancelVault;                                      // 0x09EC(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData04[0x63];                                      // 0x09ED(0x0063) MISSED OFFSET
		float                                              MaxSwimAcceleration;                                      // 0x0A50(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              MaxZSpeedOutOfWaterModifier;                              // 0x0A54(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FRotator                                    MaxSwimmingRotationRate;                                  // 0x0A58(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		struct FRotator                                    SwimmingRotationAcceleration;                             // 0x0A64(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		float                                              MaxZSpeedOutOfWaterModifierForStandingSwimming;           // 0x0A70(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              WaveRidingModifier;                                       // 0x0A74(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              WaveRidingSmoothingFactor;                                // 0x0A78(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              WaveRidingModifierUnderWater;                             // 0x0A7C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              StayingUnderWaterDepthBand;                               // 0x0A80(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData05[0x4];                                       // 0x0A84(0x0004) MISSED OFFSET
		float                                              MaxUnderwaterSwimSpeed;                                   // 0x0A88(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              MaxUnderwaterSwimAcceleration;                            // 0x0A8C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              BrakingDecelerationUnderwaterSwimming;                    // 0x0A90(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FRotator                                    MaxUnderwaterSwimmingRotationRate;                        // 0x0A94(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		struct FRotator                                    UnderwaterSwimmingRotationAcceleration;                   // 0x0AA0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		float                                              MinimumHighAltitude;                                      // 0x0AAC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData06[0x4];                                       // 0x0AB0(0x0004) MISSED OFFSET
		float                                              MaxFallLateralSpeedAtHighAltitude;                        // 0x0AB4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              TerminalVelocityAtHighAltitude;                           // 0x0AB8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              DecreaseTerminalVelocityAtHighAltitude;                   // 0x0ABC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              MaxFallAccelerationAtHighAltitude;                        // 0x0AC0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FRotator                                    FallRotationRateAtHighAltitude;                           // 0x0AC4(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AirControlAtHighAltitude;                                 // 0x0AD0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AirControlBoostMultiplierAtHighAltitude;                  // 0x0AD4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AirControlBoostVelocityThresholdAtHighAltitude;           // 0x0AD8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData07[0x4];                                       // 0x0ADC(0x0004) MISSED OFFSET
		class UClass*                                      FallingDamageType;                                        // 0x0AE0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 EjectDamageCurve;                                         // 0x0AE8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              FallingDamageMinZCut;                                     // 0x0AF0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              FallingDamageVDampingZ;                                   // 0x0AF4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              FallingDamageFactor;                                      // 0x0AF8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData08[0xC];                                       // 0x0AFC(0x000C) MISSED OFFSET
		bool                                               UseBlockedHitDamage;                                      // 0x0B08(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	...
	public:
		...
		float                                              LocomotionJumpDirection_CP;                               // 0x05D4(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LeanYaw_CP;                                               // 0x05D8(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FRotator                                    LastAbsoluteDirection_CP;                                 // 0x05DC(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    ControlRotation_CP;                                       // 0x05E8(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    ControlRotationLastMovement_CP;                           // 0x05F4(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    CharacterRotation_CP;                                     // 0x0600(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		TEnumAsByte<EAnimStance>                           Stance_CP;                                                // 0x060C(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsSprintingFast_CP;                                      // 0x060D(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsSprinting_CP;                                          // 0x060E(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData03[0x1];                                       // 0x060F(0x0001) MISSED OFFSET
		float                                              WeaponGripType_CP;                                        // 0x0610(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              SprintAlpha_CP;                                           // 0x0614(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              SprintLocoAlpha_CP;                                       // 0x0618(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              SprintValue_CP;                                           // 0x061C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bLocalQuickThrowHigh_CP;                                  // 0x0620(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData04[0x3];                                       // 0x0621(0x0003) MISSED OFFSET
		float                                              LocalThrowModeSwitchAlpha_CP;                             // 0x0624(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsJumping_CP;                                            // 0x0628(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bJumpForward_CP;                                          // 0x0629(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsSwimming_CP;                                           // 0x062A(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsUnderWater_CP;                                         // 0x062B(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsDBNO_CP;                                               // 0x062C(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		TEnumAsByte<EAnimStance>                           DBNOEntryStance;                                          // 0x062D(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsReviving_CP;                                           // 0x062E(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsUpperbody_CP;                                          // 0x062F(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsTransitioning_CP;                                      // 0x0630(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData05[0x3];                                       // 0x0631(0x0003) MISSED OFFSET
		int                                                PlayerID_CP;                                              // 0x0634(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		int                                                AirCraftIDAnim_CP;                                        // 0x0638(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsEquippingPistol_CP;                                    // 0x063C(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData06[0x3];                                       // 0x063D(0x0003) MISSED OFFSET
		class UAnimMontage*                                PistolEquipMontageRefCP;                                  // 0x0640(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bIsFlying_CP;                                             // 0x0648(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsLocalPlayer;                                           // 0x0649(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData07[0x2];                                       // 0x064A(0x0002) MISSED OFFSET
		float                                              LocalPlayerAlpha;                                         // 0x064C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsPunching_CP;                                           // 0x0650(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData08[0x3];                                       // 0x0651(0x0003) MISSED OFFSET
		float                                              PunchingAlpha_CP;                                         // 0x0654(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		TEnumAsByte<EAnimWeaponType>                       Weapon_CP;                                                // 0x0658(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsArmedWithGun_CP;                                       // 0x0659(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsArmedWithThrown_CP;                                    // 0x065A(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsPreparingThrow_CP;                                     // 0x065B(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              ThrowableAdditionalAimYaw_CP;                             // 0x065C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UAnimMontage*                                CurrentRecoilMontage_CP;                                  // 0x0660(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UBlendSpace1D*                               GripBlendSpace_CP;                                        // 0x0668(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             GripBlendSpaceLH_CP;                                      // 0x0670(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LHGripIndex_CP;                                           // 0x0678(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsReloading_CP;                                          // 0x067C(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData09[0x3];                                       // 0x067D(0x0003) MISSED OFFSET
		struct FVector                                     HandWeaponOffset_CP;                                      // 0x0680(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		unsigned char                                      UnknownData10[0x4];                                       // 0x068C(0x0004) MISSED OFFSET
		struct FTransform                                  WeaponInertia_CP;                                         // 0x0690(0x0030) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		float                                              ReloadAlpha_CP;                                           // 0x06C0(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              HandWeaponOffsetAlpha_CP;                                 // 0x06C4(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              FinalRecoilAlpha_CP;                                      // 0x06C8(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData11[0x4];                                       // 0x06CC(0x0004) MISSED OFFSET
		class UBlendSpaceBase*                             WeaponLocomotionBlendspace_CP;                            // 0x06D0(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             WeaponLocomotionBlendspace_Pistol;                        // 0x06D8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             WeaponLocomotionBlendspace_SMG;                           // 0x06E0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             WeaponLocomotionBlendspace_Rifle;                         // 0x06E8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             WeaponLocomotionBlendspace_Sniper;                        // 0x06F0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             WeaponLocomotionBlendspace_Pistol_FPP;                    // 0x06F8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             WeaponLocomotionBlendspace_SMG_FPP;                       // 0x0700(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             WeaponLocomotionBlendspace_Rifle_FPP;                     // 0x0708(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             WeaponLocomotionBlendspace_Sniper_FPP;                    // 0x0710(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaX_Scalar_CP;                                 // 0x0718(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaY_Scalar_CP;                                 // 0x071C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaX_Clamp_CP;                                  // 0x0720(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaY_Clamp_CP;                                  // 0x0724(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertia_InerpSpeed_CP;                              // 0x0728(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaX_Scalar_ADS_CP;                             // 0x072C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaY_Scalar_ADS_CP;                             // 0x0730(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaX_Clamp_ADS_CP;                              // 0x0734(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaY_Clamp_ADS_CP;                              // 0x0738(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertia_InerpSpeed_ADS_CP;                          // 0x073C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertia_InerpSpeed_YawScalar_CP;                    // 0x0740(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertia_YawToRollScalar_CP;                         // 0x0744(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertia_YawToRollScalar_ADS_CP;                     // 0x0748(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaRoll_Clamp_ADS_CP;                           // 0x074C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertiaRoll_Clamp_CP;                               // 0x0750(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponInertia_Yaw_CP;                                     // 0x0754(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              WeaponInertia_Pitch_CP;                                   // 0x0758(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              WeaponInertia_Roll_CP;                                    // 0x075C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              SprintWeaponLoweringAlpha_CP;                             // 0x0760(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              RecoilRollValue_CP;                                       // 0x0764(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              RecoilTimer_CP;                                           // 0x0768(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              RecoilRollRand_CP;                                        // 0x076C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              RecoilTimerScale_CP;                                      // 0x0770(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData12[0x4];                                       // 0x0774(0x0004) MISSED OFFSET
		class UCurveFloat*                                 RecoilRollCurve_CP;                                       // 0x0778(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponStabilityAlpha_CP;                                  // 0x0780(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              WeaponStabilityRefSpeed_CP;                               // 0x0784(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   WeaponStabilityRefMapIn_CP;                               // 0x0788(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   WeaponStabilityRefMapOut_CP;                              // 0x0790(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              WeaponStabilityInterpSpeed_CP;                            // 0x0798(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bIsAiming_CP;                                             // 0x079C(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsScoping_CP;                                            // 0x079D(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData13[0x2];                                       // 0x079E(0x0002) MISSED OFFSET
		float                                              WeaponAimState_CP;                                        // 0x07A0(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              SprintAlphaModifier_CP;                                   // 0x07A4(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsAimingBackward_CP;                                     // 0x07A8(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData14[0x3];                                       // 0x07A9(0x0003) MISSED OFFSET
		float                                              Yaw_CP;                                                   // 0x07AC(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              RotationYaw_CP;                                           // 0x07B0(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              Pitch_CP;                                                 // 0x07B4(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              YawNormalized_CP;                                         // 0x07B8(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              DesiredPitch_CP;                                          // 0x07BC(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      AimDirectionCardinal_CP;                                  // 0x07C0(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData15[0x3];                                       // 0x07C1(0x0003) MISSED OFFSET
		struct FRotator                                    AORot_CP;                                                 // 0x07C4(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    AORotBackwards_CP;                                        // 0x07D0(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		float                                              SwimmingPitch_CP;                                         // 0x07DC(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              ForceAddAimOffset_CP;                                     // 0x07E0(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              WeaponCollisionAlpha_CP;                                  // 0x07E4(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bWeaponObstructedHigh_CP;                                 // 0x07E8(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsFalling_CP;                                            // 0x07E9(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bWasFalling_CP;                                           // 0x07EA(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData16[0x1];                                       // 0x07EB(0x0001) MISSED OFFSET
		float                                              FallingAlpha_CP;                                          // 0x07EC(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FVector2D                                   FallingMap2D;                                             // 0x07F0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   FallingMapZ;                                              // 0x07F8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bForceFall_CP;                                            // 0x0800(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData17[0x7];                                       // 0x0801(0x0007) MISSED OFFSET
		class UAnimMontage*                                MontageFallingRifle_CP;                                   // 0x0808(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimMontage*                                MontageFallingUnarmed_CP;                                 // 0x0810(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              LandingAlpha_CP;                                          // 0x0818(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bLocalForceProne_CP;                                      // 0x081C(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData18[0x3];                                       // 0x081D(0x0003) MISSED OFFSET
		float                                              JumpHeight_CP;                                            // 0x0820(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              FallHeight_CP;                                            // 0x0824(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FVector                                     JumpStartLocation_CP;                                     // 0x0828(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FVector                                     LandPredictionVector_CP;                                  // 0x0834(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		float                                              LeanLeftAlpha_CP;                                         // 0x0840(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LeanRightAlpha_CP;                                        // 0x0844(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LeanTwoSideAlpha_CP;                                      // 0x0848(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LeanLeftApplyTranslation_CP;                              // 0x084C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LeanInterpSpeed_CP;                                       // 0x0850(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              LeanInterpSpeedCollisionClamp_CP;                         // 0x0854(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bUseLinearLeanInterp;                                     // 0x0858(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bIsFreefalling_CP;                                        // 0x0859(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsParachuting_CP;                                        // 0x085A(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData19[0x1];                                       // 0x085B(0x0001) MISSED OFFSET
		float                                              FreefallX_CP;                                             // 0x085C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              FreefallY_CP;                                             // 0x0860(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              FreeFallAlpha_CP;                                         // 0x0864(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsParachuteLanding_CP;                                   // 0x0868(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsParachuteMoving_CP;                                    // 0x0869(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData20[0x2];                                       // 0x086A(0x0002) MISSED OFFSET
		float                                              Freefall_Yaw_CP;                                          // 0x086C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              Freefall_Pitch_CP;                                        // 0x0870(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsFreelooking_CP;                                        // 0x0874(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsMeleeAttacking_CP;                                     // 0x0875(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bLocalForceRotationHipLeft_CP;                            // 0x0876(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bLocalForceRotationHipRight_CP;                           // 0x0877(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bLocalForceRotationAimed_CP;                              // 0x0878(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData21[0x3];                                       // 0x0879(0x0003) MISSED OFFSET
		float                                              RotationPlayrateAimed_CP;                                 // 0x087C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              RotationPlayrateAimedAdditiveSpine_CP;                    // 0x0880(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FRotator                                    LastRotation_CP;                                          // 0x0884(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    Freelook_Body_CP;                                         // 0x0890(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    Freelook_Delta_CP;                                        // 0x089C(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		int                                                IdleIndex_CP;                                             // 0x08A8(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		int                                                LastIdleIndex_CP;                                         // 0x08AC(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              IdleTimer_CP;                                             // 0x08B0(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              IdleTriggerRandom;                                        // 0x08B4(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              IdleTriggerTimeMin_CP;                                    // 0x08B8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              IdleTriggerTimeVariation_CP;                              // 0x08BC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTransform                                  SlotPrimary_CP;                                           // 0x08C0(0x0030) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FTransform                                  SlotSecondary_CP;                                         // 0x08F0(0x0030) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FTransform                                  SlotMelee_CP;                                             // 0x0920(0x0030) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FTransform                                  SlotThrown_CP;                                            // 0x0950(0x0030) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FVector                                     SlotPrimary_Offset_CP;                                    // 0x0980(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FVector                                     SlotSecondary_Offset_CP;                                  // 0x098C(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FVector                                     SlotPrimary_Location_CP;                                  // 0x0998(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FVector                                     SlotSecondary_Location_CP;                                // 0x09A4(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FVector                                     SlotMelee_Location_CP;                                    // 0x09B0(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FVector                                     SlotThrown_Location_CP;                                   // 0x09BC(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    SlotPrimary_Rotation_CP;                                  // 0x09C8(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    SlotSecondary_Rotation_CP;                                // 0x09D4(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    SlotMelee_Rotation_CP;                                    // 0x09E0(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    SlotThrown_Rotation_CP;                                   // 0x09EC(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		float                                              AnimDynamicsStandAlpha_CP;                                // 0x09F8(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AnimDynamicsStandSprintAlpha_CP;                          // 0x09FC(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AnimDynamicsCrouchAlpha_CP;                               // 0x0A00(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AnimDynamicsProneAlpha_CP;                                // 0x0A04(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FVector                                     EFCoat_CP;                                                // 0x0A08(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		bool                                               bLocalFPP_CP;                                             // 0x0A14(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData22[0x3];                                       // 0x0A15(0x0003) MISSED OFFSET
		float                                              LocalFPPAlpha_CP;                                         // 0x0A18(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LocalFPPAlphaVehicleAimAO_CP;                             // 0x0A1C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsInAircraft_CP;                                         // 0x0A20(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsDriver_CP;                                             // 0x0A21(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsSitting_CP;                                            // 0x0A22(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsInVehicle_CP;                                          // 0x0A23(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LocalSteerInput_CP;                                       // 0x0A24(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LocalSteerInputMoto_CP;                                   // 0x0A28(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LocalStopMoto_CP;                                         // 0x0A2C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              LocalThrottleInput_CP;                                    // 0x0A30(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FRotator                                    GasThighRot_CP;                                           // 0x0A34(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    GasAnkleRot_CP;                                           // 0x0A40(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		unsigned char                                      UnknownData23[0x4];                                       // 0x0A4C(0x0004) MISSED OFFSET
		struct FTransform                                  GasKneeTransformX_CP;                                     // 0x0A50(0x0030) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		float                                              LocalBrakeInput_CP;                                       // 0x0A80(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData24[0xC];                                       // 0x0A84(0x000C) MISSED OFFSET
		struct FTransform                                  BrakeKneeTransform_CP;                                    // 0x0A90(0x0030) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		struct FRotator                                    BrakeAnkleRot_CP;                                         // 0x0AC0(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		float                                              BackwardAOAlpha_CP;                                       // 0x0ACC(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AimBlendAlpha_CP;                                         // 0x0AD0(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bHasContact_CP;                                           // 0x0AD4(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData25[0x3];                                       // 0x0AD5(0x0003) MISSED OFFSET
		float                                              GroundContactMoto_CP;                                     // 0x0AD8(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AirControlPitchInput_CP;                                  // 0x0ADC(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FTransform                                  DriverIK_CP;                                              // 0x0AE0(0x0030) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		float                                              PassengerIKAlpha_CP;                                      // 0x0B10(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FVector                                     DriverSpineLocWS_CP;                                      // 0x0B14(0x000C) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		EVehicleAnimType                                   VehicleSeatType_CP;                                       // 0x0B20(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bMotoHasDriver_CP;                                        // 0x0B21(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bVaultCanceled;                                           // 0x0B22(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsVaulting_CP;                                           // 0x0B23(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AnimHairAlpha;                                            // 0x0B24(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultTimer_CP;                                            // 0x0B28(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultTimerLast_CP;                                        // 0x0B2C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		EVaultAnimType                                     LocalVaultType_CP;                                        // 0x0B30(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData26[0x7];                                       // 0x0B31(0x0007) MISSED OFFSET
		class UAnimSequenceBase*                           VaultAnimSequence_CP;                                     // 0x0B38(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultAnimLength_CP;                                       // 0x0B40(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData27[0x4];                                       // 0x0B44(0x0004) MISSED OFFSET
		class UCurveFloat*                                 VaultCurve_CP;                                            // 0x0B48(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultBlendInTime_CP;                                      // 0x0B50(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultBlendOutTime_CP;                                     // 0x0B54(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bEndVaultToFall_CP;                                       // 0x0B58(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData28[0x3];                                       // 0x0B59(0x0003) MISSED OFFSET
		float                                              VaultBlendOutProgressTime_CP;                             // 0x0B5C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultBlendOutExactTime_CP;                                // 0x0B60(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultLastActionTimer_CP;                                  // 0x0B64(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultAnimTime_CP;                                         // 0x0B68(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              VaultBlendOutTimeBuffer;                                  // 0x0B6C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		ECastAnim                                          CurrentCastAnim_CP;                                       // 0x0B70(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsActiveRagdoll_CP;                                      // 0x0B71(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData29[0x2];                                       // 0x0B72(0x0002) MISSED OFFSET
		float                                              WeaponIKLH_CP;                                            // 0x0B74(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              WeaponIKRH_CP;                                            // 0x0B78(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              MontageIKLH_CP;                                           // 0x0B7C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              MontageIKRH_CP;                                           // 0x0B80(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              IgnoreWeaponTransform_CP;                                 // 0x0B84(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              PickupIKAlpha_CP;                                         // 0x0B88(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              TargetIKRH_CP;                                            // 0x0B8C(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              TargetIKLH_CP;                                            // 0x0B90(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              ForceLegsFromAnim_CP;                                     // 0x0B94(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class ATslWeapon_Gun*                              LastGunCache_CP;                                          // 0x0B98(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class ATslWheeledVehicle*                          CachedWheeledVehicle_CP;                                  // 0x0BA0(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class ATslFloatingVehicle*                         CachedFloatingVehicle_CP;                                 // 0x0BA8(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             PassengerAimBS_CP;                                        // 0x0BB0(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             PassengerTransitionOut_CP;                                // 0x0BB8(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UBlendSpaceBase*                             PassengerTransitionIn_CP;                                 // 0x0BC0(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UAnimSequenceBase*                           PassengerIdle_Rifle_CP;                                   // 0x0BC8(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UAnimSequenceBase*                           PassengerIdle_Unarmed_CP;                                 // 0x0BD0(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UAnimSequenceBase*                           PassengerIdle_Grenade_CP;                                 // 0x0BD8(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UAnimSequenceBase*                           PassengerIdle_Melee_CP;                                   // 0x0BE0(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UCurveFloat*                                 CurveAimState_CP;                                         // 0x0BE8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData30[0x8];                                       // 0x0BF0(0x0008) MISSED OFFSET
		bool                                               bIsLOD1;                                                  // 0x0BF8(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsLOD2;                                                  // 0x0BF9(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsWearingCoat;                                           // 0x0BFA(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData31[0x9];                                       // 0x0BFB(0x0009) MISSED OFFSET
		float                                              AnimatedHairsAlpha;                                       // 0x0C04(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsParentalControl;                                       // 0x0C08(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData32[0x7];                                       // 0x0C09(0x0007) MISSED OFFSET
		class UAnimMontage*                                MontageMeleeAttack1;                                      // 0x0C10(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimMontage*                                MontageMeleeAttack2;                                      // 0x0C18(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimMontage*                                MontageMeleeAttack3;                                      // 0x0C20(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimMontage*                                MontagePunchingAttack1;                                   // 0x0C28(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimMontage*                                MontagePunchingAttack2;                                   // 0x0C30(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimMontage*                                MontagePunchingAttack3;                                   // 0x0C38(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              FPPSprintAnimScalar;                                      // 0x0C40(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     FPP_PrimaryAndSecondaryItemOffset;                        // 0x0C44(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              PunchingAlphaOneTarget_CP;                                // 0x0C50(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              PunchingAlphaInterpSpeed;                                 // 0x0C54(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SprintWeaponLoweringScalar_CP;                            // 0x0C58(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              ThrowStateSwitchInterpSpeed;                              // 0x0C5C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              VaultingEvalTimeout;                                      // 0x0C60(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData33[0x4];                                       // 0x0C64(0x0004) MISSED OFFSET
		class UAnimDB*                                     UnarmedAnimDB_CP;                                         // 0x0C68(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimDB*                                     RifleAnimDB_CP;                                           // 0x0C70(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimDB*                                     MeleeAnimDB_CP;                                           // 0x0C78(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAnimDB*                                     GrenadeAnimDB_CP;                                         // 0x0C80(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData34[0x8];                                       // 0x0C88(0x0008) MISSED OFFSET
		struct FTransform                                  DefaultSlotPrimary_Male_CP;                               // 0x0C90(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTransform                                  DefaultSlotSecondary_Male_CP;                             // 0x0CC0(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTransform                                  DefaultSlotMelee_Male_CP;                                 // 0x0CF0(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTransform                                  DefaultSlotThrown_Male_CP;                                // 0x0D20(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTransform                                  DefaultSlotPrimary_Female_CP;                             // 0x0D50(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTransform                                  DefaultSlotSecondary_Female_CP;                           // 0x0D80(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTransform                                  DefaultSlotThrown_Female_CP;                              // 0x0DB0(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FTransform                                  DefaultSlotMelee_Female_CP;                               // 0x0DE0(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SprintLocoTimeMultiplier;                                 // 0x0E10(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SprintLocoTimeMultiplier_FPP;                             // 0x0E14(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SprintLocoTimeAlphaScalar;                                // 0x0E18(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SprintLocoTimeAlphaScalar_FPP;                            // 0x0E1C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	public:
		...
		bool                                               bUseHighlight;                                            // 0x0674(0x0001) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x33];                                      // 0x0675(0x0033) MISSED OFFSET
		...
		class UHighlightSession*                           HighlightSession;                                         // 0x0908(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData06[0xA0];                                      // 0x0910(0x00A0) MISSED OFFSET
	...
	public:
		class UClass*                                      DialogUMGWidgetClass;                                     // 0x0028(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bSupportKillcamEnable;                                    // 0x0030(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData00[0x3];                                       // 0x0031(0x0003) MISSED OFFSET
		int                                                MaxReplaysForNullStreamer;                                // 0x0034(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepDistance_Item;                                         // 0x0038(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepDistance_Character;                                    // 0x003C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepDistance_Weapon;                                       // 0x0040(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepDistance_Vehicle;                                      // 0x0044(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepDistance_Parachute;                                    // 0x0048(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepDistance_Door;                                         // 0x004C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepDistance_Window;                                       // 0x0050(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepFrequency_Character;                                   // 0x0054(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepFrequency_WheeledVehicle;                              // 0x0058(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepFrequency_FloatingVehicle;                             // 0x005C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepFrequency_Parachute;                                   // 0x0060(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepFrequency_Aircraft;                                    // 0x0064(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepFrequency_CarePackage;                                 // 0x0068(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepVehicle_SpawnDistance;                                 // 0x006C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RepVehicle_UnspawnDistance;                               // 0x0070(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		struct FRigidBodyErrorCorrection                   RepVehicle_PhysicErrorCorrection;                         // 0x0074(0x001C) (CPF_Edit, CPF_Config)
		float                                              CharacterCorrection_MaxSpeed;                             // 0x0090(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              CharacterCorrection_MaxSpeedPositionError;                // 0x0094(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              CharacterCorrection_ZeroSpeedPositionError;               // 0x0098(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bBattlEyeEnabled;                                         // 0x009C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bBattlEyeEnabledInPIE;                                    // 0x009D(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x2];                                       // 0x009E(0x0002) MISSED OFFSET
		float                                              BattlEyeReliablePacketIntervalOnClient;                   // 0x00A0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              BattlEyeReliablePacketIntervalOnServer;                   // 0x00A4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bChineseLicensing;                                        // 0x00A8(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bKoreanRating;                                            // 0x00A9(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData02[0x2];                                       // 0x00AA(0x0002) MISSED OFFSET
		float                                              GameStateLogInterval;                                     // 0x00AC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              ServerStatLogInterval;                                    // 0x00B0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              CharacterPositionLogInterval;                             // 0x00B4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              DestructibleComponentMaxDrawDistance;                     // 0x00B8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData03[0x4];                                       // 0x00BC(0x0004) MISSED OFFSET
		class UClass*                                      CharacterClassToPlay;                                     // 0x00C0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		TArray<struct FBoneBinding>                        BoneMapping;                                              // 0x00C8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FStringAssetReference>               TestVehicleClasses;                                       // 0x00D8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FStringAssetReference>               TestFloatingVehicleClasses;                               // 0x00E8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FChineseLicensingDefaultCustomizeData> ChineseLicensingDefaultCustomizeData;                     // 0x00F8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		float                                              StoppedWheeledVehicleSpeedThreshold;                      // 0x0108(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              StoppedFloatingVehicleSpeedThreshold;                     // 0x010C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              LastDriverDuration;                                       // 0x0110(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              InteractableDistanceToleranceOnDedicatedServer;           // 0x0114(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              InteractableDistance_ItemDefault;                         // 0x0118(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              InteractableSpeed_ItemDefault;                            // 0x011C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		struct FInteractionCollisionData                   InteractionCollisionForFPS;                               // 0x0120(0x0014) (CPF_Edit, CPF_Config)
		struct FInteractionCollisionData                   InteractionCollisionForTPS;                               // 0x0134(0x0014) (CPF_Edit, CPF_Config)
		bool                                               bPreventFinishMatchInPIE;                                 // 0x0148(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bEnableInitialItemDonator;                                // 0x0149(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData04[0x2];                                       // 0x014A(0x0002) MISSED OFFSET
		float                                              InventoryMaxSpaceDefault;                                 // 0x014C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		class UTexture*                                    ErrorIconTexture;                                         // 0x0150(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UTexture*                                    LoadingIconTexture;                                       // 0x0158(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		TArray<class UObject*>                             AssetsForPackageIntegrity;                                // 0x0160(0x0010) (CPF_ZeroConstructor)
		float                                              UICrosshairDistance;                                      // 0x0170(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              UICrosshairInterpSpeed;                                   // 0x0174(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              UICrosshairDisableDistance;                               // 0x0178(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData05[0xC];                                       // 0x017C(0x000C) MISSED OFFSET
		float                                              GameTimeMultiplier;                                       // 0x0188(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               AimOffsetRayCast;                                         // 0x018C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		...
		bool                                               EnableThrowLagCompensation;                               // 0x0198(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               FullRecoilRecovery;                                       // 0x0199(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		...
		TArray<struct FNearClippingValue>                  NearClippingValues;                                       // 0x01B0(0x0010) (CPF_ZeroConstructor, CPF_Config)
		TArray<struct FTslGame_FCustomizableCategoryData>  CustomizableCategoryData;                                 // 0x01C0(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FCustomizableActionName>             CustomizableActionNames;                                  // 0x01D0(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FTslGame_FCustomizableAxisName>      CustomizableAxisNames;                                    // 0x01E0(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FCustomizableMouseSensitiveName>     CustomizableMouseSensitiveNames;                          // 0x01F0(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FCustomizableGamePadSensitiveName>   CustomizableGamePadSensitiveNames;                        // 0x0200(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FSurportQualityLevel>                SupportedQualityLevels;                                   // 0x0210(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FScreenResolution>                   SupportedScreenResolutions;                               // 0x0220(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		struct FStringAssetReference                       MouseSensitivityCurve;                                    // 0x0230(0x0010) (CPF_Edit, CPF_Config)
		struct FStringAssetReference                       GammaCurve;                                               // 0x0240(0x0010) (CPF_Edit, CPF_Config)
		TArray<struct FString>                             CultureNames;                                             // 0x0250(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		...
		unsigned char                                      UnknownData09[0x4];                                       // 0x02AC(0x0004) MISSED OFFSET
		...
		float                                              ClientSideHitLeeway;                                      // 0x02C8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		...
		float                                              TravelDistanceLeeway;                                     // 0x02D4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              AllowedHitLag;                                            // 0x02D8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              LogMinHitLag;                                             // 0x02DC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              HackDetectionSpeed;                                       // 0x02E0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData10[0x4];                                       // 0x02E4(0x0004) MISSED OFFSET
		TArray<struct FOverrideScalability>                OverrideScalabilities;                                    // 0x02E8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		float                                              FakeDoorBlockMaxY;                                        // 0x02F8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData11[0x4];                                       // 0x02FC(0x0004) MISSED OFFSET
		TArray<struct FReportCauseData>                    ReportCauses;                                             // 0x0300(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FSubjectToReport>                    SubjectToReport;                                          // 0x0310(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		float                                              FreelookRecoveryInterpSpeed;                              // 0x0320(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData12[0x4];                                       // 0x0324(0x0004) MISSED OFFSET
		TMap<struct FName, float>                          GamepadSensitiveMultiplier;                               // 0x0328(0x0050) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		float                                              GamePadInnerDeadZone;                                     // 0x0378(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              GamePadOutDeadZoneAcceleration;                           // 0x037C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              GamePadOutMaxAxisValue;                                   // 0x0380(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              GamePadAccelerationStandardFps;                           // 0x0384(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              AimAssistDecisionRadius;                                  // 0x0388(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bApplyInputValue;                                         // 0x038C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bIgnorePadSensitive;                                      // 0x038D(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData13[0x2];                                       // 0x038E(0x0002) MISSED OFFSET
		float                                              InsensitiveZone;                                          // 0x0390(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData14[0x4];                                       // 0x0394(0x0004) MISSED OFFSET
		TArray<struct FAimAssistData>                      AimCameraAssists;                                         // 0x0398(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FAimAssistData>                      ADSCameraAssists;                                         // 0x03A8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FAimAssistData>                      Scope2XCameraAssists;                                     // 0x03B8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FAimAssistData>                      Scope4XCameraAssists;                                     // 0x03C8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FAimAssistData>                      Scope8XCameraAssists;                                     // 0x03D8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TArray<struct FAimAssistData>                      Scope15XCameraAssists;                                    // 0x03E8(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		bool                                               bIsESports;                                               // 0x03F8(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData15[0x57];                                      // 0x03F9(0x0057) MISSED OFFSET
		class UCurveFloat*                                 LoadedMouseSensitivityCurve;                              // 0x0450(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		class UCurveFloat*                                 LoadedGammaCurve;                                         // 0x0458(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		class UTextureRenderTarget2D*                      CharacterStudioRenderTarget;                              // 0x0460(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		TArray<struct FName>                               AnimatableHairNames;                                      // 0x0468(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_Config)
		TMap<struct FName, float>                          NotifyDistanceLimitMap;                                   // 0x0478(0x0050) (CPF_Edit, CPF_ZeroConstructor)
	...
	public:
		...
		unsigned char                                      UnknownData02[0x140];                                     // 0x0290(0x0140) MISSED OFFSET
		class ULobbyWidget*                                LobbyWidget;                                              // 0x03D0(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_IsPlainOldData)
		unsigned char                                      UnknownData03[0xA8];                                      // 0x03D8(0x00A8) MISSED OFFSET
		TArray<struct FReplayKillEventItem>                ReplayKillEventItems;                                     // 0x0480(0x0010) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor)
		struct FScriptMulticastDelegate                    OnEnumerateReplayKillEventsDone;                          // 0x0490(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		unsigned char                                      UnknownData04[0xA0];                                      // 0x04A0(0x00A0) MISSED OFFSET
		TArray<struct FReplayGroggyEventItem>              ReplayGroggyEventItems;                                   // 0x0540(0x0010) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor)
		struct FScriptMulticastDelegate                    OnEnumerateReplayGroggyEventsDone;                        // 0x0550(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		unsigned char                                      UnknownData05[0x10];                                      // 0x0560(0x0010) MISSED OFFSET
		TArray<struct FReplayItem>                         ReplayItemList;                                           // 0x0570(0x0010) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor)
		unsigned char                                      UnknownData06[0x38];                                      // 0x0580(0x0038) MISSED OFFSET
		struct FScriptMulticastDelegate                    OnGetReplayListDone;                                      // 0x05B8(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		struct FScriptMulticastDelegate                    OnGotoTimelineDone;                                       // 0x05C8(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		struct FScriptMulticastDelegate                    OnRecordStarted;                                          // 0x05D8(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		struct FScriptMulticastDelegate                    OnDownloadZippedReplayProgressDelegate;                   // 0x05E8(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		struct FScriptMulticastDelegate                    OnDownloadZippedReplayCompleteDelegate;                   // 0x05F8(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		unsigned char                                      UnknownData07[0x28];                                      // 0x0608(0x0028) MISSED OFFSET
		int                                                MaxReplaysForNullStreamer;                                // 0x0630(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		int                                                NumReplaysForNullStreamer;                                // 0x0634(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		int                                                NumReplaysToKeepForNullStreamer;                          // 0x0638(0x0004) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData08[0x4];                                       // 0x063C(0x0004) MISSED OFFSET
		struct FScriptMulticastDelegate                    OnKeepAndDeleteOldestReplaysDoneDelegate;                 // 0x0640(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		unsigned char                                      UnknownData09[0x8];                                       // 0x0650(0x0008) MISSED OFFSET
		class UGameEventObserver*                          GameEventObserver;                                        // 0x0658(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData10[0x18];                                      // 0x0660(0x0018) MISSED OFFSET
		struct FTslReplaySummary                           ReplaySummaryForPlayback;                                 // 0x0678(0x0080) (CPF_BlueprintVisible, CPF_BlueprintReadOnly)
		struct FScriptMulticastDelegate                    OnGetReplaySummaryDone;                                   // 0x06F8(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		bool                                               bIsStartedFromReplayListMap;                              // 0x0708(0x0001) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData11[0x7];                                       // 0x0709(0x0007) MISSED OFFSET
		class ATslPlayerState*                             CachedDemoPlayerState;                                    // 0x0710(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData12[0xB8];                                      // 0x0718(0x00B8) MISSED OFFSET
	...
	public:
		...
		class UCurveFloat*                                 CameraTransitionCurve;                                    // 0x09B8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              CameraTransitionElapsedTime;                              // 0x09C0(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsCameraTransitionPlaying;                               // 0x09C4(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		ELobbyCameraStates                                 LastCameraState;                                          // 0x09C5(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		ELobbyCameraStates                                 FromCameraState;                                          // 0x09C6(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		ELobbyCameraStates                                 ToCameraState;                                            // 0x09C7(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		TMap<int, class ACameraActor*>                     LobbyCameras;                                             // 0x09C8(0x0050) (CPF_ZeroConstructor)
		struct FName                                       MainMenuStreamingLevelName;                               // 0x0A18(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FName                                       CustomizationStreamingLevelName;                          // 0x0A20(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UCurveFloat*                                 FadeInOutCurve;                                           // 0x0A28(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class ATslPostProcessEffect*                       LobbyPPE;                                                 // 0x0A30(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              FadeInOutEffectElapsedTime;                               // 0x0A38(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsFadeInOutEffectPlaying;                                // 0x0A3C(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x3];                                       // 0x0A3D(0x0003) MISSED OFFSET
		struct FTimerHandle                                TimerHandle_FadeInOut;                                    // 0x0A40(0x0008)
		class ATslPostProcessEffect*                       MainMenuPPE;                                              // 0x0A48(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		ELobbyBlurChangingStates                           BlurChangingState;                                        // 0x0A50(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bInitCameraTransition;                                    // 0x0A51(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData02[0x6];                                       // 0x0A52(0x0006) MISSED OFFSET
		struct FScriptMulticastDelegate                    OnCreateCharacter;                                        // 0x0A58(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		struct FScriptMulticastDelegate                    OnDestroyCharacter;                                       // 0x0A68(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		struct FString                                     StartURL;                                                 // 0x0A78(0x0010) (CPF_Edit, CPF_ZeroConstructor)
		TArray<class UCoherentCommonBinder*>               CommonBinders;                                            // 0x0A88(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		class UAkComponent*                                AkSound;                                                  // 0x0A98(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
		class ACameraActor*                                MainCamera;                                               // 0x0AA0(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData03[0x20];                                      // 0x0AA8(0x0020) MISSED OFFSET
		class UClass*                                      LobbyCharacterMaleClass;                                  // 0x0AC8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UClass*                                      LobbyCharacterFemaleClass;                                // 0x0AD0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData04[0x50];                                      // 0x0AD8(0x0050) MISSED OFFSET
		struct FViewTargetTransitionParams                 ViewTargetTransitionParams;                               // 0x0B28(0x0010) (CPF_Edit)
		unsigned char                                      UnknownData05[0x8];                                       // 0x0B38(0x0008) MISSED OFFSET
	...
	public:
		int                                                AmmoClips;                                                // 0x0A18(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData00[0x4];                                       // 0x0A1C(0x0004) MISSED OFFSET
		class UClass*                                      WeaponType;                                               // 0x0A20(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x50];                                      // 0x0A28(0x0050) MISSED OFFSET
	...
	// 0x0028 (0x0A40 - 0x0A18)
	class ATslDemoSpectator : public ATslPlayerController {
	public:
		unsigned char                                      UnknownData00[0x28];                                      // 0x0A18(0x0028) MISSED OFFSET
	...
	public:
		...
		bool                                               bUseKillcam;                                              // 0x0204(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               bPreloadingMap;                                           // 0x0205(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData07[0x2];                                       // 0x0206(0x0002) MISSED OFFSET
	...
	public:
		...
		bool STATIC_GetKillcamSupported();
		bool STATIC_GetKillcamEditable();
	...
	public:
		...
		float                                              DestructSoundOcclusionRefreshInterval;                    // 0x09D8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x4];                                       // 0x09DC(0x0004) MISSED OFFSET
		class UDestructibleComponent*                      DestructibleComponent;                                    // 0x09E0(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
		unsigned char                                      bReplicatedOnClient : 1;                                  // 0x09E8(0x0001) (CPF_Net)
		unsigned char                                      bDestroyed : 1;                                           // 0x09E8(0x0001) (CPF_Net)
		unsigned char                                      UnknownData02[0x17];                                      // 0x09E9(0x0017) MISSED OFFSET
	...
	public:
		...
		float                                              DestructSoundOcclusionRefreshInterval;                    // 0x0BD8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      bReplicatedOnClient : 1;                                  // 0x0BDC(0x0001) (CPF_Net)
		unsigned char                                      UnknownData01[0x13];                                      // 0x0BDD(0x0013) MISSED OFFSET
		TArray<int>                                        DestroyedInstances;                                       // 0x0BF0(0x0010) (CPF_Net, CPF_ZeroConstructor)
		TArray<int>                                        PendingDestroyInstances;                                  // 0x0C00(0x0010) (CPF_Net, CPF_ZeroConstructor)
		unsigned char                                      UnknownData02[0xD0];                                      // 0x0C10(0x00D0) MISSED OFFSET
	...
	public:
		...
		unsigned char                                      UnknownData00[0x1C0];                                     // 0x0BE0(0x01C0) MISSED OFFSET
	...
	public:
		struct FProjectileWeaponData                       ProjectileConfig;                                         // 0x0AE0(0x0008) (CPF_Edit, CPF_DisableEditOnInstance)
	...
	public:
		...
		float                                              LimitMinFreeCamFov;                                       // 0x04BC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              LimitMaxFreeCamFov;                                       // 0x04C0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData06[0xC];                                       // 0x04C4(0x000C) MISSED OFFSET
		float                                              FollowCameraZoomSpeed;                                    // 0x04D0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              LimitTargetArmLength;                                     // 0x04D4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class ATslCharacter*                               DeathCharacter;                                           // 0x04D8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              SpectatableCheckLength;                                   // 0x04E0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              SpectatableCheckScreenRatio;                              // 0x04E4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData07[0x18];                                      // 0x04E8(0x0018) MISSED OFFSET
		class UClass*                                      OutlineEffectClass;                                       // 0x0500(0x0008) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		class ATslPostProcessEffect*                       OutlineEffect;                                            // 0x0508(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		TArray<struct FSavedObPos>                         ArrObPos;                                                 // 0x0510(0x0010) (CPF_ZeroConstructor, CPF_Config)
		unsigned char                                      UnknownData08[0x70];                                      // 0x0520(0x0070) MISSED OFFSET
		...
		unsigned char                                      UnknownData09[0x50];                                      // 0x05B0(0x0050) MISSED OFFSET
	...
	public:
		...
		struct FUmgWidgetBinder_Animation                  SwitchAnimationBinder;                                    // 0x0440(0x0020) (CPF_Edit, CPF_BlueprintVisible)
		struct FUmgWidgetBinder_Animation                  SwitchAnimationResetBinder;                               // 0x0460(0x0020) (CPF_Edit, CPF_BlueprintVisible)
		struct FUmgWidgetBinder_WidgetSwitcher             InteractionInputMethodSwitcherBinder;                     // 0x0480(0x0020) (CPF_Edit, CPF_BlueprintVisible)
		struct FName                                       InteractionKeyName;                                       // 0x04A0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FUmgWidgetBinder_Image                      ProgressCircle_Binder;                                    // 0x04A8(0x0028) (CPF_Edit, CPF_BlueprintVisible)
		struct FLinearColor                                InteractionTextColor_Interactable;                        // 0x04D0(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		struct FLinearColor                                InteractionTextShadowColor_Interactable;                  // 0x04E0(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		struct FLinearColor                                InteractionTextColor_NotInteractable;                     // 0x04F0(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		struct FLinearColor                                InteractionTextShadowColor_NotInteractable;               // 0x0500(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	...
	public:
		...
		float                                              ZoomLevel;                                                // 0x0430(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              ShowGridZoomLevel;                                        // 0x0434(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UCurveFloat*                                 ViewRatioCurve;                                           // 0x0438(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bRectangleViewMode;                                       // 0x0440(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x7];                                       // 0x0441(0x0007) MISSED OFFSET
		class UFont*                                       GridFont;                                                 // 0x0448(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FName                                       FontTypeFace;                                             // 0x0450(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		TArray<struct FString>                             GridTextHorizentalArray;                                  // 0x0458(0x0010) (CPF_Edit, CPF_ZeroConstructor)
		TArray<struct FString>                             GridTextVerticalArray;                                    // 0x0468(0x0010) (CPF_Edit, CPF_ZeroConstructor)
		struct FLinearColor                                ColorLargeGrid;                                           // 0x0478(0x0010) (CPF_Edit, CPF_IsPlainOldData)
		struct FLinearColor                                ColorSmallGrid;                                           // 0x0488(0x0010) (CPF_Edit, CPF_IsPlainOldData)
		struct FLinearColor                                ColorText;                                                // 0x0498(0x0010) (CPF_Edit, CPF_IsPlainOldData)
		struct FLinearColor                                ColorSafetyZone;                                          // 0x04A8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		float                                              ThicknessLargeGrid;                                       // 0x04B8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              ThicknessSmallGrid;                                       // 0x04BC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FLinearColor                                ColorPoisonGasWarning;                                    // 0x04C0(0x0010) (CPF_Edit, CPF_IsPlainOldData)
		bool                                               bDrawGridLine;                                            // 0x04D0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bDrawGridText;                                            // 0x04D1(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bDrawNextPlayzoneGuideLine;                               // 0x04D2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bUseZOrderSort;                                           // 0x04D3(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bUseTeamMemberColor;                                      // 0x04D4(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bRemoveDeadIcon;                                          // 0x04D5(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData02[0x2];                                       // 0x04D6(0x0002) MISSED OFFSET
		struct FLinearColor                                DefaultIconNameTagColor;                                  // 0x04D8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		unsigned char                                      UnknownData03[0x10];                                      // 0x04E8(0x0010) MISSED OFFSET
		class UMaterialInstanceDynamic*                    MatInst;                                                  // 0x04F8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData04[0x18];                                      // 0x0500(0x0018) MISSED OFFSET
		class UMapMarkerBaseWidget*                        MyMapMarker;                                              // 0x0518(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_IsPlainOldData)
		TMap<class ATeam*, class UMapMarkerBaseWidget*>    TeamPlayerMarkers;                                        // 0x0520(0x0050) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient)
		class UMapCharacterIconBaseWidget*                 MyCharacterMapIcon;                                       // 0x0570(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_IsPlainOldData)
		TMap<class AActor*, class UMapCharacterIconBaseWidget*> OtherCharacterMapIcons;                                   // 0x0578(0x0050) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient)
		TMap<class ACarePackageItem*, class UMapCarePackageItemIconBaseWidget*> MapCarePackageItemIcons;                                  // 0x05C8(0x0050) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient)
		struct FTimerHandle                                ReplicatedCharacterListUpdateTimer;                       // 0x0618(0x0008) (CPF_Transient)
		struct FTimerHandle                                ReplicatedCarePackageItemListUpdateTimer;                 // 0x0620(0x0008) (CPF_Transient)
		TArray<class ATslCharacter*>                       ReplicatedCharacterList;                                  // 0x0628(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		TArray<class ACarePackageItem*>                    ReplicatedCarePackageItemList;                            // 0x0638(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		TArray<class ATeam*>                               ShowMarkerOnwerList;                                      // 0x0648(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		unsigned char                                      UnknownData05[0x20];                                      // 0x0658(0x0020) MISSED OFFSET
		class UMaterialInstance*                           MyOrTeamIconMaterial;                                     // 0x0678(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UMaterialInstance*                           OtherCharacterIconMaterial;                               // 0x0680(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FScriptMulticastDelegate                    CloseMySelf;                                              // 0x0688(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
		struct FScriptMulticastDelegate                    OnHideOwner;                                              // 0x0698(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
	...
	public:
		...
		float                                              DefaultImageAlpha;                                        // 0x02DC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              DefaultTextAlpha;                                         // 0x02E0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AmingImageAlpha;                                          // 0x02E4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              ScopingImageAlpha;                                        // 0x02E8(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              AmingTextAlpha;                                           // 0x02EC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              ScopingTextAlpha;                                         // 0x02F0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FVector2D                                   OffScreenEdgeSize;                                        // 0x02F4(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		struct FVector2D                                   OffScreenImageEdgeSize;                                   // 0x02FC(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
		float                                              AnimationMaxDistance;                                     // 0x0304(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
		struct FUmgWidgetBinder_Gerneral                   StateSwitcherBinder;                                      // 0x0308(0x0020) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_TextBlock                  PlayerNameTextBinder;                                     // 0x0328(0x0020) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Image                      OutLineImageBinder;                                       // 0x0348(0x0028) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Image                      DirectionImageBinder;                                     // 0x0370(0x0028) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Image                      NormalImageBinder;                                        // 0x0398(0x0028) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Image                      GroggyImageBinder;                                        // 0x03C0(0x0028) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Image                      DeadImageBinder;                                          // 0x03E8(0x0028) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Image                      VehicleImageBinder;                                       // 0x0410(0x0028) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Image                      ParachuteImageBinder;                                     // 0x0438(0x0028) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Image                      QuitterImageBinder;                                       // 0x0460(0x0028) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Animation                  ScaleOpacityByDistanceAnim;                               // 0x0488(0x0020) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FUmgWidgetBinder_Border                     ImageMarkBorderBinder;                                    // 0x04A8(0x0020) (CPF_Edit, CPF_DisableEditOnInstance)
		class UTexture*                                    OutScreenImage;                                           // 0x04C8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UTexture*                                    GroggyImage;                                              // 0x04D0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UTexture*                                    VehicleImage;                                             // 0x04D8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UTexture*                                    ParachuteImage;                                           // 0x04E0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	public:
		...
		struct FVector                                     NameTagOffsetTranslation;                                 // 0x0368(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
		bool                                               bIsHost;                                                  // 0x0374(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsReady;                                                 // 0x0375(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		bool                                               bIsSpeaking;                                              // 0x0376(0x0001) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	public:
		...
		float                                              BrakeNoDriverMultiplier;                                  // 0x0448(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                VelocityInterpSpeed;                                      // 0x044C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                SlipInterpSpeed;                                          // 0x0450(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                SpinInterpSpeed;                                          // 0x0454(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		int                                                BreakInterpSpeed;                                         // 0x0458(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bDebugVisualizedMeasuredWheels;                           // 0x045C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData05[0x3];                                       // 0x045D(0x0003) MISSED OFFSET
		float                                              AngularVelocityCoefficient;                               // 0x0460(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              LateralVelocityCoeffictient;                              // 0x0464(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              LateralVelocityClamp;                                     // 0x0468(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bProcessShiftStart;                                       // 0x046C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bProcessShiftEnd;                                         // 0x046D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bProcessReverse;                                          // 0x046E(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData06[0x1];                                       // 0x046F(0x0001) MISSED OFFSET
		class UAkAudioEvent*                               GearUpSound_Start;                                        // 0x0470(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               GearDownSound_Start;                                      // 0x0478(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               GearUpSound_End;                                          // 0x0480(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               GearDownSound_End;                                        // 0x0488(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UAkAudioEvent*                               GearReverseSound;                                         // 0x0490(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData07[0x90];                                      // 0x0498(0x0090) MISSED OFFSET
		TMap<int, class UMaterialInterface*>               DestroyedMaterialMap;                                     // 0x0528(0x0050) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
		float                                              ApplyDestroyedMaterialDelay;                              // 0x0578(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData08[0x4];                                       // 0x057C(0x0004) MISSED OFFSET
	...
	// 0x01F8 (0x0CD8 - 0x0AE0)
	class ATslWeapon_Trajectory : public ATslWeapon_Gun {
	public:
		float                                              TrajectoryGravityZ;                                       // 0x0AE0(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RecoilSpreadScale;                                        // 0x0AE4(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		bool                                               FireAtViewPoint;                                          // 0x0AE8(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData00[0x3];                                       // 0x0AE9(0x0003) MISSED OFFSET
		float                                              DefaultTimerFrequency;                                    // 0x0AEC(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              CrouchSpreadModifier;                                     // 0x0AF0(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              ProneSpreadModifier;                                      // 0x0AF4(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              WalkSpread;                                               // 0x0AF8(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              RunSpread;                                                // 0x0AFC(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              JumpSpread;                                               // 0x0B00(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x4];                                       // 0x0B04(0x0004) MISSED OFFSET
		struct FTrajectoryWeaponData                       TrajectoryConfig;                                         // 0x0B08(0x0080) (CPF_Edit, CPF_DisableEditOnInstance)
		struct FRecoilInfo                                 RecoilInfo;                                               // 0x0B88(0x0068) (CPF_Edit, CPF_DisableEditOnInstance)
		class UClass*                                      ImpactTemplate;                                           // 0x0BF0(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UParticleSystem*                             TrailFX;                                                  // 0x0BF8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		TMap<float, class UClass*>                         UnderWaterTrailFXClassPerLength;                          // 0x0C00(0x0050) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance)
		struct FName                                       TrailTargetParam;                                         // 0x0C50(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData02[0x18];                                      // 0x0C58(0x0018) MISSED OFFSET
		float                                              WeaponSpread;                                             // 0x0C70(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              RecoilModifier_Stand;                                     // 0x0C74(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              RecoilModifier_Crouch;                                    // 0x0C78(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              RecoilModifier_Prone;                                     // 0x0C7C(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              VerticalRecoilMin;                                        // 0x0C80(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		float                                              VerticalRecoilMax;                                        // 0x0C84(0x0004) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	...
	// 0x01A8 (0x08D0 - 0x0728)
	class ATslMotorbikeVehicle : public ATslWheeledVehicle {
	public:
		bool                                               bUseKickstandStabilize;                                   // 0x0728(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData00[0x3];                                       // 0x0729(0x0003) MISSED OFFSET
		float                                              MinSuspensionOffsetForContact;                            // 0x072C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bStabilizeOnServer;                                       // 0x0730(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x3];                                       // 0x0731(0x0003) MISSED OFFSET
		float                                              KickstandStabilizeDamping;                                // 0x0734(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              KickstandMaxAngVelocity;                                  // 0x0738(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              DefaultAngularDamping;                                    // 0x073C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              KickstandStabilizeTorqueScalar;                           // 0x0740(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              KickstandStabilizeRollScalar;                             // 0x0744(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              KickstandStabilizeRollMinRange;                           // 0x0748(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              MinVelocityForStabilizeOverride;                          // 0x074C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FName                                       StabilizeBone_Low;                                        // 0x0750(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FName                                       StabilizeBone_High;                                       // 0x0758(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_Roll;                                               // 0x0760(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_RollReturn;                                         // 0x0768(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_Steer;                                              // 0x0770(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_Yaw;                                                // 0x0778(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		class UCurveFloat*                                 Curve_Torque;                                             // 0x0780(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     StabStaticVector;                                         // 0x0788(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     StabStaticVectorKickstand;                                // 0x0794(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     StabNoDriverVector;                                       // 0x07A0(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabX_Velocity_In;                                        // 0x07AC(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabX_Velocity_Out;                                       // 0x07B4(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabX_Pitch_In;                                           // 0x07BC(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabX_Pitch_Out;                                          // 0x07C4(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabZ_Velocity_In;                                        // 0x07CC(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabZ_Velocity_Out;                                       // 0x07D4(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabZ_Roll_In;                                            // 0x07DC(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabZ_Roll_Out;                                           // 0x07E4(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabZ_Pitch_In;                                           // 0x07EC(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabZ_Pitch_Out;                                          // 0x07F4(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabTorque_In;                                            // 0x07FC(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabTorque_Out;                                           // 0x0804(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              StabTorque_ForceScalar;                                   // 0x080C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabTorque_Pitch_In;                                      // 0x0810(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   StabTorque_Pitch_Out;                                     // 0x0818(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bUseFlipping;                                             // 0x0820(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData02[0x3];                                       // 0x0821(0x0003) MISSED OFFSET
		float                                              FlippingForce;                                            // 0x0824(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              InitialFlipTimer;                                         // 0x0828(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              MinVelocityForFlipping;                                   // 0x082C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData03[0x4];                                       // 0x0830(0x0004) MISSED OFFSET
		float                                              ContactAlpha_RiseRate;                                    // 0x0834(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              ContactAlpha_FallRate;                                    // 0x0838(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              ContactAlpha_LowerClamp;                                  // 0x083C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   ContactAlpha_MapPitchIn;                                  // 0x0840(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   ContactAlpha_MapRollIn;                                   // 0x0848(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   AirControlF_VelMap;                                       // 0x0850(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   AirControlB_VelMap;                                       // 0x0858(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   AirControlL_VelMap;                                       // 0x0860(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   AirControlR_VelMap;                                       // 0x0868(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   AirControlQ_VelMap;                                       // 0x0870(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector2D                                   AirControlE_VelMap;                                       // 0x0878(0x0008) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AirControl_FB_Torque;                                     // 0x0880(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AirControl_LR_Torque;                                     // 0x0884(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              AirControl_QE_Torque;                                     // 0x0888(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		bool                                               bStabilizeInAir;                                          // 0x088C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData04[0x3];                                       // 0x088D(0x0003) MISSED OFFSET
		float                                              StabilizeAirPercentage;                                   // 0x0890(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              FC_PitchUp;                                               // 0x0894(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              FC_PitchDown;                                             // 0x0898(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		unsigned char                                      UnknownData05[0x31];                                      // 0x089C(0x0031) MISSED OFFSET
		bool                                               bKickstandStabilize;                                      // 0x08CD(0x0001) (CPF_Net, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		unsigned char                                      UnknownData06[0x2];                                       // 0x08CE(0x0002) MISSED OFFSET
	...
	public:
		float                                              Sidecar_COM_Y_Left;                                       // 0x08D0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		float                                              Sidecar_COM_Y_Right;                                      // 0x08D4(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		struct FVector                                     Sidecar_StabilizerHigh_StaticCOM;                         // 0x08D8(0x000C) (CPF_Edit, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	public:
		...
		unsigned char                                      UnknownData01[0x8];                                       // 0x01F8(0x0008) MISSED OFFSET
		struct FVivoxConnectionInfo                        ConnectionInfo;                                           // 0x0200(0x0020) (CPF_Net)
		unsigned char                                      UnknownData02[0x8];                                       // 0x0220(0x0008) MISSED OFFSET
		struct FString                                     TeamChannelUrl;                                           // 0x0228(0x0010) (CPF_Net, CPF_ZeroConstructor)
		struct FString                                     GlobalChannelUrl;                                         // 0x0238(0x0010) (CPF_Net, CPF_ZeroConstructor)
		unsigned char                                      UnknownData03[0x4];                                       // 0x0248(0x0004) MISSED OFFSET
		float                                              ResetFailureDelaySeconds;                                 // 0x024C(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData04[0x18];                                      // 0x0250(0x0018) MISSED OFFSET
		float                                              UpdatePositionIntervalSeconds;                            // 0x0268(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData05[0xC];                                       // 0x026C(0x000C) MISSED OFFSET
		float                                              UserInputVolumeModifier;                                  // 0x0278(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		float                                              UserOutputVolumeModifier;                                 // 0x027C(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	public:
		unsigned char                                      UnknownData00[0x2C];                                      // 0x0280(0x002C) MISSED OFFSET
		float                                              SuddenMovementDistance;                                   // 0x02AC(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              SuddenMovementModifier;                                   // 0x02B0(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              SuddenMovementModifierDuration;                           // 0x02B4(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              SuddenMovementModifierRestoreDuration;                    // 0x02B8(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x4];                                       // 0x02BC(0x0004) MISSED OFFSET
		bool                                               bEnableObserverTeamChat;                                  // 0x02C0(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData02[0xF];                                       // 0x02C1(0x000F) MISSED OFFSET
