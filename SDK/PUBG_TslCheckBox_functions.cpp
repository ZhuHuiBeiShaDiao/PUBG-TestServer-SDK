...
// Function TslCheckBox.TslCheckBox_C.OnPreviewKeyDown
...
struct FEventReply UTslCheckBox_C::OnPreviewKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
	static UFunction* fn = nullptr;
	if (!fn) fn = UObject::FindObject<UFunction>(0xdd16a9d5);

	UTslCheckBox_C_OnPreviewKeyDown_Params params;
	params.MyGeometry = MyGeometry;
	params.InKeyEvent = InKeyEvent;
