...
namespace Classes {
	...
	// Function TslGame.InstantHealItem.GetHealLimit
	struct UInstantHealItem_GetHealLimit_Params {
		float                                              ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData)
	};
	...
	// Function TslGame.MutableCharacter.HasAnimatableHair
	struct AMutableCharacter_HasAnimatableHair_Params {
		bool                                               ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData)
	};
	...
	// Function TslGame.TslGameOption.GetKillcamSupported
	struct UTslGameOption_GetKillcamSupported_Params {
		bool                                               ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData)
	};

	// Function TslGame.TslGameOption.GetKillcamEditable
	struct UTslGameOption_GetKillcamEditable_Params {
		bool                                               ReturnValue;                                              // (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData)
	};
