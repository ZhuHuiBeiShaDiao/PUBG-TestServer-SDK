...
namespace Classes
{
	...
	public:
		...
		float                                              BeaconConnectionInitialTimeout;                           // 0x03B0(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		float                                              BeaconConnectionTimeout;                                  // 0x03B4(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		class UNetDriver*                                  NetDriver;                                                // 0x03B8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	{
	public:
		class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x03D0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		class UNetConnection*                              BeaconConnection;                                         // 0x03D8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		EBeaconConnectionState                             ConnectionState;                                          // 0x03E0(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData00[0x5F];                                      // 0x03E1(0x005F) MISSED OFFSET
	...
	{
	public:
		int                                                ListenPort;                                               // 0x03D0(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
		unsigned char                                      UnknownData00[0x4];                                       // 0x03D4(0x0004) MISSED OFFSET
		TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x03D8(0x0010) (CPF_ZeroConstructor)
	...
	{
	public:
		struct FString                                     BeaconTypeName;                                           // 0x03A8(0x0010) (CPF_ZeroConstructor, CPF_Transient)
		class UClass*                                      ClientBeaconActorClass;                                   // 0x03B8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x03C0(0x0010) (CPF_ZeroConstructor)
	...
	{
	public:
		class UPartyBeaconState*                           State;                                                    // 0x03D0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData00[0x148];                                     // 0x03D8(0x0148) MISSED OFFSET
