...
namespace Classes
{
	...
	public:
		...
		struct FVector                                     CurrentSpectatorPawnLocation;                             // 0x02F0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
		...
		struct FVector2D                                   MouseDownPosition;                                        // 0x0304(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
