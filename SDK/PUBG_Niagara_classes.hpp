...
namespace Classes {
	...
	public:
		...
		TArray<struct FNiagaraScriptDataInterfaceInfo>     EffectDataInterfaceLocalOverrides;                        // 0x0850(0x0010) (CPF_Edit, CPF_ZeroConstructor)
		TArray<class UNiagaraDataInterface*>               InstanceDataInterfaces;                                   // 0x0860(0x0010) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient)
