...
namespace Classes {
	...
	public:
		...
		bool                                               bUseComplexAsSimpleCollision;                             // 0x0938(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
		unsigned char                                      UnknownData01[0x7];                                       // 0x0939(0x0007) MISSED OFFSET
		class UBodySetup*                                  ProcMeshBodySetup;                                        // 0x0940(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData)
		TArray<struct FProcMeshSection>                    ProcMeshSections;                                         // 0x0948(0x0010) (CPF_ZeroConstructor)
		TArray<struct FKConvexElem>                        CollisionConvexElems;                                     // 0x0958(0x0010) (CPF_ZeroConstructor)
		struct FBoxSphereBounds                            LocalBounds;                                              // 0x0968(0x001C) (CPF_IsPlainOldData)
