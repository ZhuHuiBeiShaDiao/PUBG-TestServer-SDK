...
namespace Classes
{
	...
	public:
		...
		struct FScriptMulticastDelegate                    OnInputAction;                                            // 0x03B8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable)
