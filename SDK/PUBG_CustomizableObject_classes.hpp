...
namespace Classes
{
	...
	public:
		...
		unsigned char                                      UnknownData01[0x106];                                     // 0x0092(0x0106) MISSED OFFSET
		class UCustomizableInstancePrivateData*            PrivateData;                                              // 0x0198(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
		TArray<TWeakObjectPtr<class UTexture2D>>           CreatedTextures;                                          // 0x01A0(0x0010) (CPF_ZeroConstructor)
	...
	public:
		...
		struct FGuid                                       VersionId;                                                // 0x00B4(0x0010) (CPF_IsPlainOldData)
	...
	public:
		...
		TArray<struct FMutableSkeletalMeshTracker>         SkeletalMeshTrackerArray;                                 // 0x0050(0x0010) (CPF_ZeroConstructor)
		TArray<struct FMutableTextureTracker>              TextureTrackerArray;                                      // 0x0060(0x0010) (CPF_ZeroConstructor)
